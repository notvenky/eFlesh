...
parser.add_argument('output_densities', default=None, help='output cutcells densities')
...
print("Step 6: Print densities json")
...
json_file = open(args.output_densities, 'w')
