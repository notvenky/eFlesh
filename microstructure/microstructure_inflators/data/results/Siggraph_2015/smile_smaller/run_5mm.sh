...
$MICROSTRUCTURES_PATH/parameter_lookup/lookup.py \
    ...
    #--geometry-correction-lookup=$MICROSTRUCTURES_PATH/wire_generator/examples/geometry_correction_new_pdms_2.csv \
$MICROSTRUCTURES_PATH/parameter_lookup/generate_config.py \
    $MICROSTRUCTURES_PATH/patterns/3D/reference_wires/wires.txt \
    results/guide.msh \
    results/smile.config

$MICROSTRUCTURES_PATH/wire_generator/tile.py \
    -o results/smile_microstructure.obj \
    results/smile.config
...
$MICROSTRUCTURES_PATH/Nico/printing_optimizer/bin/support_gen \
    results/smile.wire \
    results/smile_guide.obj \
    results/smile_microstructure.obj \
    0 0 1 \
    3.0 \
    results/smile_reorientated.wire \
    results/smile_support.wire \
    results/smile_guide.obj \
    results/smile_microstructure_reorientated.obj

$MICROSTRUCTURES_PATH/wire_generator/inflate.py \
    --thickness 0.5 \
    -o results/smile_support.obj \
    --subdiv 0 \
    results/smile_support.wire
